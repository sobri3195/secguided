          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="mt-1 block w-full px-3 py-2.5 sm:py-3 border border-dark-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 bg-dark-700 text-white"
              >
            ...
            <div>
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleChange}
                  className={`h-4 w-4 text-cyan-600 focus:ring-cyan-500 border-dark-600 rounded bg-dark-700 mt-1 flex-shrink-0 ${
