        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <div className="text-2xl font-extrabold text-cyan-400">SG</div>
              <span className="text-xl font-bold text-white">SecGuided</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Learn Security, Reverse Engineering & Defensive Research
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#forums" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Forums
                </a>
              </li>
              <li>
                <a href="#tutorials" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Tutorials
                </a>
              </li>
              <li>
                <a href="#downloads" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Downloads
                </a>
              </li>
            </ul>
